...
This project was developed with the assistance of Gemini(Google) and Claude for guidance on architecture design, documentation formatting, troubleshooting, code modifications, and the creation of Kubernetes YAML configuration files. All implementation, configuration, and testing were performed and validated by the author.
