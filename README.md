...
This project was developed with the assistance of Gemini (Google) and Claude for guidance on the architecture design, documentation formatting, troubleshooting, code modifications, and the creation of YAML configuration files. All implementation, configuration, and testing were performed and validated by me.
